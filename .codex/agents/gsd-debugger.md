...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-01/.codex
                  → checks /Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-01/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-01/.codex/get-shit-done
                  → writes to /Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-01/.codex/get-shit-done/hooks/
...
@/Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-01/.codex/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-01/.codex/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-01/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-01/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-01/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
