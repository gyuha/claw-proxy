...
```bash
PHASE_INFO=$(node "/Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-02/.codex/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-02/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" --pick found)
...
```bash
PHASE_DIR=$(node "/Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-02/.codex/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
