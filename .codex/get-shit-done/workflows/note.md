...
- **Global scope**: `/Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-01/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-01/.codex/notes/`)
...
2. Glob `/Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-01/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-01/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-01/.codex/notes/` — works in any directory
