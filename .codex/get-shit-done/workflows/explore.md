...
```bash
node "/Users/gyuha/workspace/claw-proxy-worktrees/feat-gsd-01/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: capture exploration — {topic_slug}" --files {file_list}
```
